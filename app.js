...
var incompleteTaskHolder=document.querySelector(".incomplete__list");//ul of incomplete_list
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="list__input_content";
...
//Mark task as incomplete.
    ...
    //Append the task list item to the incomplete__title.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
